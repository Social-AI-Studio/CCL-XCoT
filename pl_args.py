...
def add_model_args(parent_parser):
    ...
    parser.add_argument("--model_name", type=str, default='meta-llama/Meta-Llama-3-8B', choices=["gpt2", "google/gemma-7b", "Salesforce/codegen-350M-mono", "meta-llama/Meta-Llama-3-8B", "/home/weihua/Haullucination/ContraCLM/Model_llama"])
    parser.add_argument("--pad_token_id", type=int, default=128001)  # see here https://github.com/salesforce/CodeGen/blob/2ca076874ca2d26c2437df2968f6c43df92748bc/jaxformer/hf/sample.py#L201
    ...
    # dataloading
    parser.add_argument("--train_batch_size", type=int, default=256, help="Batch size for training combined across all devices.")
